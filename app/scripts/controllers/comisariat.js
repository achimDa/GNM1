...
/**
 * @ngdoc function
 * @name gnmApp.controller:ComisariatCtrl
 * @description
 * # ComisariatCtrl
 * Controller of the gnmApp
 */
angular.module('gnmApp')
    .controller('ComisariatCtrl', ['$scope', 'HelpersService', '$sessionStorage', '$location', '$http', '$q', '$resource', 'Upload', '$routeParams', '$window', 'Go',
        function($scope, HelpersService, $sessionStorage, $location, $http, $q, $resource, Upload, $routeParams, $window, Go) {
            ...
            $scope.session.addLink.title = 'Comisariat';
            ...
            if (($location.search().edit === 'true') && $sessionStorage.editableRow) {
                ...
                $scope.postComisariat = $resource(url + 'organisations/comisariat/' + $sessionStorage.editableRow.id, {}, {
                    makeRequest: {
                        method: 'GET',
                        isArray: false
                    }
                ...
                $scope.postComisariat.$promise.then(function(success) {
                    ...
                    var url_Licenses = 'accounts/licenses/organisations/' + $sessionStorage.editableRow.organisation.id,
                        ...
                        url_Commissar =  'accounts/organisations/' + $sessionStorage.editableRow.organisation.id + '/countycommissars';
                    ...
                    $scope.getCommissar = $resource(url + url_Commissar, null, options).get();
                    ...
                    $scope.getCommissar.$promise.then(function(success) {
                        $scope.formDropdownData.commissar = success.items;
                    }, errorCallback);
            ...
            $scope.localAdminState = function(systemObj) {
                ...
                system = {
                  ...
                  'notificationAccount': (typeof systemObj.notificationAccount !== 'undefined') && (systemObj.notificationAccount !== null)  ? {
                      'id': systemObj.notificationAccount.id 
                  } : null,
                  'canValidate' : systemObj.canValidate
            ...
            $scope.sendPost = function() {
                ...
                newItemObj = {
                    ...
                    'isCommissareatGeneral': (typeof $scope.itemObj.isCommissareatGeneral !== 'undefined') && ($scope.itemObj.isCommissareatGeneral !== null) ? $scope.itemObj.isCommissareatGeneral : false
                };

                var url_comisariat = url + 'organisations/comisariat',
                    options = {
                        makeRequest: {
                            method: 'POST',
                            isArray: false
                ...
                if ($routeParams.edit === 'true') {
                    url_comisariat = url + 'organisations/' + $scope.itemObj.organisation.id + '/comisariat/' +  $scope.itemObj.id;
                ...
                $scope.postComisariat.$promise.then(function(response) {
                    ...
                    $location.url('/comisariat?edit=true');
