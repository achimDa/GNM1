...
/**
 * @ngdoc function
 * @name gnmApp.controller:HartaTaraCtrl
 * @description
 * # HartaTaraCtrl
 * Controller of the gnmApp
 */
angular.module('gnmApp')
  .controller('HartaTaraCtrl', ['$scope', 'Upload', '$timeout', '$resource','$location', '$sessionStorage', 'HelpersService', 'Go' ,'leafletData',
    ...
    $scope.session.title = 'Harta tara';
    ...
    var url_country = 'countries/' + $sessionStorage.editableRow.id + '/countrygeom';
    ...
    $scope.sendFile = function(files) {
        ...
        $resource(url + 'countries/' + $sessionStorage.editableRow.id + '/uploadcountry', null, {
            postWithFile: {
                method: "POST",
                params: $scope.fdata,
