...
/**
 * @ngdoc function
 * @name gnmApp.controller:TipLegislatieCtrl
 * @description
 * # TipLegislatieCtrl
 * Controller of the gnmApp
 */
angular.module('gnmApp')
  .controller('TipLegislatieCtrl', ['$scope','$resource','HelpersService','$location','$sessionStorage','Go',
	...
	$scope.sendPost = function(itemObj) {
    	var url_species = url + 'legislationtypes',
            options = {
                makeRequest: {
                    isArray: false
                }
        ...
        if (($location.search().edit === 'true') && $sessionStorage.editableRow) {
            url_species = url + 'legislationtypes/' + $scope.itemObj.id;
