...
/**
 * @ngdoc function
 * @name gnmApp.controller:SpeciiRegnulAnimaliaCtrl
 * @description
 * # SpeciiRegnulAnimaliaCtrl
 * Controller of the gnmApp
 */
angular.module('gnmApp')
  .controller('SpeciiRegnulAnimaliaCtrl',  ['$scope','$resource','HelpersService','$location','$sessionStorage','Go',
